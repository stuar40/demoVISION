...
<head>
    ...
    <title>Usuarios | MacroVision</title>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Mantenimiento Usuarios</a></li>
                                
                                
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                
                            <form class="form-horizontal" method="post" id="formUsuario" name="formUsuario"><!-- le asigna un identificador al formulario para generar un post y enviar los datos  -->
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          ...
                                          <div class="js-form-message mb-6">
                                              ...
                                              <button type="button" class="btn btn-custon-rounded-two btn-primary" name="verUsuarios" id="verUsuarios">Ver Usuarios</button>
                                              </div>
                                          </div>
                                          <!-- End Input -->
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <div class="js-form-message mb-6">
                                              ...
                                              <div class="js-focus-state input-group form">
                                              <button type="button" class="btn btn-custon-rounded-two btn-primary" onclick="window.location.href='5NuevoUsuario.php'"  name="nuevoUsuario" id="nuevoUsuario">(+) Nuevo Usuario</button>
                                              </div>
                                          </div>
                                          <!-- End Input -->
                                        </div>
                                      ...
                                      <div class="row" id="divUsuarios" style="display: block">
                                          <div id="myTabContent" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 responsive-mode tab-content-center table-responsive-md justify-center" >
                                             ...
                                             <table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tablaVerUsuarios">
                                                ...
                                                <tbody>
                                                  <?php 
                                                  $query_select = mysqli_query($conexionbd,"SELECT idUsuario,priNombreUsuario,priApellidoUsuario, estadoUsuario,descripcionUsuario FROM usuario");
                                                  ...
                                                  <?php
                                                    if ($num_rows > 0) {
                                                      ...
                                                      ?>          
                                                              ...
                                                              <td class="text-center"><?php echo $row['priNombreUsuario'] ?> <?php echo $row['priApellidoUsuario']?></td>
                                                              <td class="text-center"><?php echo $row['descripcionUsuario']?></td>
                                                              <td class="text-center"><?php echo $row['estadoUsuario']?></td>
       ...
       <!-- ========== LLama a ventanas Modales ========== -->
        <?php
            //  include("modal/modalprueba.php") ; // modal que permite Guardar el usuario
             include("modal/modal5VerUsuario.php") ;// modal que permite Guardar el usuario
