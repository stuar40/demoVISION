...
<body>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Sucursales</a></li>
                                
                                
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                
                            <form class="form-horizontal" method="post" id="Sucursales" name="Sucursales"><!-- le asigna un identificador al formulario para generar un post y enviar los datos  -->
                                    ...
                                    <div id="verSucursales" class="active"> <!-- asigna un id al bloque donde estan los campos de nuevo asesor proveedor-->
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          ...
                                          <div class="js-form-message mb-6">
                                              ...
                                              <button type="button" class="btn btn-custon-rounded-two btn-success" name="nuevaSucursal" id="nuevaSucursal">(+) Sucursal</button>
                                              </div>
                                          </div>
                                          <!-- End Input -->
                                        </div>
                                      ...
                                      <div id="myTabContent" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 responsive-mode tab-content-center table-responsive-md justify-center" >
                                          ...
                                          <table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tablaverSucursales">
                                              ...
                                              <tbody>
                                                <?php 
                                                $query_select = mysqli_query($conexionbd,"SELECT *  FROM sucursal ");
                                                ...
                                                <?php
                                                  if ($num_rows > 0) {
                                                    ...
                                                    ?>          
                                                            ...
                                                            <tr>
                                                            <td class="text-center"><?php echo $row['idSucursal']?></td>
                                                            <td><?php echo $row['nombreSucursal']?></td>
                                                            <td><?php echo $row['telefonoSucursal']?></td>
                                                            <td><?php echo $row['direccionSucursal']?></td>
       ...
       <!-- ========== LLama a ventanas Modales ========== -->
        <?php
            //  include("modal/modalprueba.php") ; // modal que permite Guardar el usuario
             include("modal/modalSucursales.php") ;// modal que permite Guardar el usuario
    ...
    <script type="text/javascript" src="jq/2Sucursales.js">  </script> 
