...
///////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   if (isset($_POST['submit'])) {
                                    if (empty($_POST['username']) || empty($_POST['password'])) {
                                                $error = "Username o Password es invalido";
                                    }
                                    ...
                                    else
                                    {
                                       ...
                                       $result = mysqli_query($conexionbd,"SELECT idUsuario,usuario,ciudadSucursal,passUsuario FROM usuario inner join sucursal on usuario.Sucursal_idSucursal=sucursal.idSucursal where usuario ='" . $_POST["username"] . "' and passUsuario = '". $_POST["password"]."'");
                                       ...
                                       // $counter=mysqli_num_rows($query);
                                          ...
                                          if(is_array($row)){
                                             ...
                                             $_SESSION["sucursal"] = $row['Sucursal_idSucursal'];
